...
public class StudentRelatedTests {
	...
	public void setUpData() {
		...
		Student s2 = new Student("Nan Wint", "SA63", LocalDate.of(2000, 1, 1),"Geek", 4.6, 2026, 2027);
		Student s3 = new Student("Alicia", "SA63", LocalDate.of(2001, 12, 12),"Ms.Familiar", 4.5, 2026, 2027);
		Student s4 = new Student("Quek", "SA63", LocalDate.of(2001, 12, 12),"Sounds Interesting", 5.0, 2026, 2027);
		Student s5 = new Student("Ramesh", "SA63", LocalDate.of(2001, 12, 12),"Mr.Polite", 4.5, 2026, 2027);
		Student s6 = new Student("Senthil", "SA63", LocalDate.of(2001, 12, 12),"Mr.Interactive", 4.5, 2026, 2027);
    ...
    class Crud {
        @Test 
        void findAll() {
        	Student testStudent = new Student("Senthil", "SA63", LocalDate.of(2001, 12, 12),"Mr.Interactive", 4.5, 2026, 2027);
        ...
        @Test
        void save() {
        	Student testStudent = new Student("Tay Dominc", "SA63", LocalDate.of(2025, 12, 12),"Mr.Prodigy", 5.0, 2026, 2027);
        ...
        void update()
        {
        	// Option null, one , list get() top record
        	Optional<Student> sample = studentRepo.findById(1);
        	sample.get().setNickName("Mr.Nerd");
        	studentRepo.save(sample.get());
        	assertThat(sample.get()).extracting(Student::getNickName).asString().contains("Mr.Nerd");
        }
        @Test
        void delete()
        {
